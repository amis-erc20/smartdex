...
What is Amis Smart Dex ?

# smartdex

Amis Smart dex is part of the ERC20-AMIS Token Future, options and crypto derivatives Project. Smart Dex is a web front end designed to interact with the 0x relay infrastructure offering off-chain order-book signed orders generated by the ethereum blockchain.

<img align="left" src="https://github.com/amis-erc20/smartdex/blob/gh-pages/assets/img/exchange.png" alt="amis-smartdex"/>
